...
export function Pagination({ page, totalPages, onPageChange }: PaginationProps) {
  ...
  return (
    <nav className="flex items-center justify-center gap-1" aria-label="Pagination">
      <button
        className="rounded-md border border-zinc-300 px-3 py-1.5 text-sm hover:bg-zinc-50 disabled:opacity-40 disabled:pointer-events-none dark:border-zinc-700 dark:hover:bg-zinc-800"
